...
var redirect = 'https://cd524f14.ngrok.io/callback';var view = {
  auth_url: 'https://accounts.spotify.com/authorize?client_id='+client_id+'&response_type=code&redirect_uri='+redirect+'&scope=user-read-private%20user-read-email'
};
    ...
    request.post(authOptions, function(error, response, body) {
      if (!error && response.statusCode === 200) {
        ...
        function storeUserData(user_id, user_email){
          connection.query('INSERT INTO users (id,email,auth_token,refresh_token) VALUES (?,?,?,?)',[user_id,user_email,access_token,refresh_token], (error,todos,fields)=>{
            if(error){
